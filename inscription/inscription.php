        ...
        <div class="signup-card">
          ...
          <div class="form-group">
            ...
            <input
              ...
              placeholder="ex: Jean"
            />
            <span id="errPrename" class="error"><?php echo $err['prename'] ?? ''; ?></span>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="password"
            />
            <span id="errPass" class="error"><?php echo $err['password'] ?? ''; ?></span>
          </div>
          <div class="form-group">
            ...
            <input
              ...
              name="adress"
            />
            <span id="errAdress" class="error"><?php echo $err['adress'] ?? ''; ?></span>
          </div>
          <div class="form-group">
            ...
            />
            <span id="errPhone" class="error"><?php echo $err['phone'] ?? ''; ?></span>
          </div>
          <div class="form-group">
          ...
          <p class="login-link">
            Déjà un compte ?
            <a href="../se connecter/bienvenue.html">Se connecter</a>
          </p>
        </div>
      </form>
    </div>
