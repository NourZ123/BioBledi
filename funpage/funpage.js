...
const liste_des_legumes = [
    ...
    { nom: "Carotte", image: "carrot-salad-vegetables-svgrepo-com.svg", points: 12 },
    { nom: "Piment", image: "chili-fruit-spicy-svgrepo-com.svg", points: 20 },
    { nom: "Pomme", image: "apples-food-svgrepo-com.svg", points: 10 },
    { nom: "Aubergine", image: "aubergine-svgrepo-com.svg", points: 12 },
    { nom: "Orange", image: "orange-svgrepo-com.svg", points: 10 }
];
...
function faireTomberLegume(legume) {
    ...
    const pointsgagnes = Math.round(legume.points * reglages.multiplicateurPoints);
    ...
    const animationChute = setInterval(function() {
        ...
        const nouvellePosition = hauteurDepart + (hauteurArrivee - hauteurDepart) * progression;
...
function terminerPartie() {
    ...
    afficherMessage(`Partie terminée ! Score final : ${scoretotal} points`, "info");
}
...
function demarrerNouvellePartie() {
    ...
    afficherMessage(" La pêche commence ! Attrape les fruits et légumes qui tombent !", "success");
}
...
function changerDifficulte() {
    ...
    // Afficher un message
    afficherMessage(`Difficulté : ${select.options[select.selectedIndex].text}`, "info");
}
...
function initialiserPage() {
    ...
    afficherMessage("Bienvenue ! Clique sur Démarrer pour commencer à pêcher !", "info");
}
