      ...
      <div class="card">
        ...
        <div class="section">
          ...
          <div class="choice-group">
            <button type="button" class="choice" id='adress' name='ADomicile'
              style="font-weight: bold; font-size: 16px; height: 90px">A domicile</button>
            <button type="button" class="choice" id='PR' name='PR'
              style="font-weight: bold; font-size: 16px; height: 90px">Point relais</button>
            <button type="button" class="choice" id='surplace' name='surplace'
              style="font-weight: bold; font-size: 16px; height: 90px">Retirer de la ferme</button>
        ...
        <div id="adr" style="display: none;">
          <div class="form-group">
            <label>Adresse</label>
            <input type="text" class="form-input" id="point_relais" placeholder="ex: 123 rue de la Paix"
              name="adress" />
        ...
        <div class="section">
          ...
          <div class="choice-group">
            <button type="button"" name=" mode_paiement" value="carte" class="choice payment" id="cardpayment"
              style="font-weight: bold;  font-size: 16px;">
              <img src="../images/credit-card-svgrepo-com.svg" alt="card" /> Carte bancaire
            </button>
            <button type="button" name="mode_paiement" value="cash" class="choice payment" id="cash"
              style="font-weight: bold;  font-size: 16px;">
        ...
        <div class="card-payment">
          ...
          <div class="form-group">
            ...
            <input type="text" id="card-number" placeholder="XXXX XXXX XXXX XXXX" length="16" name="cardnumber" />
          ...
          <div class="row">
            ...
            <div class="form-group">
              <label>CVC</label>
              <input type="text" placeholder="123" maxlength="3" minlength="3" name="cvc" />
            </div>
          </div>
        </div>

        <div class="buttons">
          <a href="../PHP/panier.php"><button class="btn2">Retour</button></a>
