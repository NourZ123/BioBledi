    ...
    <div class="page-compte">
      <div class="menu-lateral">
        ...
        <div class="liste-options">
          <div id="btn-dashboard" class="option-menu" style="padding: 10px"><img src="../images/screen-alt-2-svgrepo-com (1).svg" class="icone-menu" /> Tableau de bord</div>
          <div id="btn-infos" class="option-menu" style="padding: 10px"><img src="../images/information-point-svgrepo-com.svg" class="icone-menu" /> Mes informations</div>
          <div id="btn-Commande" class="option-menu" style="padding: 10px"><img src="../images/cart-large-2-svgrepo-com.svg" class="icone-menu" /> Mes commandes</div>
        ...
        <div id="vue-dashboard">
          ...
          <div class="grille-deux-colonnes">
            <div class="carte-info carte-personnelles">
              ...
              <div class="conteneur-modifier"><a href="../PHP/modifier.php" class="lien-modifier">Modifier mes informations</a></div>
            </div>
        ...
        <div id="vue-infos" style="display: none">
          ...
          <div class="carte-info" style="width: 100%; max-width: 100%; margin-top: 20px; padding: 30px;">
            ...
            <div class="conteneur-modifier" style="margin-top: 30px">
              <a href="../PHP/modifier.php" class="lien-modifier" style="padding: 10px 20px; background-color: #14532d; color: white; border-radius: 5px; text-decoration: none;">Modifier mes informations</a>
            </div>
          </div>
        </div>
