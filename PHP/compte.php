...
<body>
  <div class="head">
    <div class="head-left">
      ...
      <div class="page-title-container">
        <p class="page-title"><strong>Mon Compte</strong></p>
      </div>
    ...
    <div class="head-right">
      <div class="head-actions">
        <a href="../PHP/check_compte.php"><img src="../images/person-svgrepo-com.svg" class="user-icon" /></a>
        <a href="../PHP/panier.php"><img src="../images/cart-2-svgrepo-com.svg" class="cart-icon" /></a>
      </div>
    </div>
  </div>
  ...
  <div class="page-compte">
    <div class="menu-lateral">
      <div class="titre-section"><img src="../images/person-svgrepo-com.svg" class="icone-titre" /> Compte client</div>
      <div class="liste-options">
        <div id="btn-dashboard" class="option-menu" style="padding: 10px"><img
            src="../images/screen-alt-2-svgrepo-com (1).svg" class="icone-menu" /> Tableau de bord</div>
    ...
    <div class="zone-principale">
      <div id="vue-dashboard">
        <div class="bloc-bienvenue">
          <h1 class="titre-bienvenue">Bonjour
            <?php echo htmlspecialchars($prename ?: 'Visiteur') ?> !
          </h1>
        ...
        <div class="grille-trois-cartes">
          <div class="carte-info carte-total">
            ...
            <p class="nombre-total">
              <?= $total_commandes ?> commande
              <?= $total_commandes > 1 ? 's' : '' ?>
            </p>
          </div>
          <div class="carte-info carte-derniere">
            ...
            <?php if ($derniere_commande): ?>
              <p class="ref-derniere">CMD
                <?= $derniere_commande->id_commande ?> -
                <?= number_format($derniere_commande->montant, 2) ?> dt
              </p>
              <p class="adresse-derniere">
                <?= htmlspecialchars($derniere_commande->adresse) ?>
              </p>
            <?php else: ?>
          ...
          <div class="carte-info carte-adresse">
            ...
            <p class="details-adresse">
              <?php echo htmlspecialchars($adress ?: 'Votre Adresse') ?>
            </p>
          </div>
        </div>
        <div class="grille-deux-colonnes">
          <div class="carte-info carte-personnelles">
            ...
            <div class="grille-personnelles">
              <p class="element-personnel"><span class="label-personnel">Nom :</span>
                <?= htmlspecialchars($name ?: 'Fouleni') ?>
              </p>
              <p class="element-personnel"><span class="label-personnel">Prénom :</span>
                <?= htmlspecialchars($prename ?: 'Foulen') ?>
              </p>
              <p class="element-personnel"><span class="label-personnel">Email :</span>
                <?= htmlspecialchars($email ?: 'Foulen.Fouleni@gmail.com') ?>
              </p>
              <p class="element-personnel"><span class="label-personnel">Téléphone :</span>
                <?= htmlspecialchars($phone ?: '12 345 678') ?>
              </p>
              <p class="element-personnel"><span class="label-personnel">Adresse :</span>
                <?= htmlspecialchars($adress ?: 'Tunis, El Manar, 2092') ?>
              </p>
            </div>
            <div class="conteneur-modifier"><a href="../PHP/modifier.php" class="lien-modifier">Modifier mes
                informations</a></div>
          </div>
      ...
      <div id="vue-infos" style="display: none">
        ...
        <div class="carte-info" style="width: 100%; max-width: 100%; margin-top: 20px; padding: 30px;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; font-size: 18px;">
            ...
            <p class="element-personnel" style="grid-column: span 2"><span class="label-personnel">Adresse :</span>
              <?= htmlspecialchars($adress ?: 'Tunis, El Manar, 2092') ?>
            </p>
          </div>
          <div class="conteneur-modifier" style="margin-top: 30px">
            <a href="../PHP/modifier.php" class="lien-modifier"
              style="padding: 10px 20px; background-color: #14532d; color: white; border-radius: 5px; text-decoration: none;">Modifier
              mes informations</a>
          </div>
        </div>
      </div>
  ...
  <footer class="footer">
    <div class="footer-container">
      <div class="footer-brand">
        <img src="../images/logo.jpg" class="logo" alt="Logo de BioBladi en pied de page" />
      ...
      <div class="footer-contact">
        ...
        <p>
          <img src="../images/phone-svgrepo-com (1).svg" alt="Icône" class="footer-icon" />
          +216 12 345 678
        </p>
        <p>
          <img src="../images/mail-check-svgrepo-com.svg" alt="Icône " class="footer-icon" />
          contact@biobladi.tn
        </p>
        <p>
          <img src="../images/location-svgrepo-com.svg" alt="I" class="footer-icon" />
          Tunis, Tunisie
        </p>
        <p>
          <img src="../images/time-svgrepo-com.svg" alt="Icône d'horloge" class="footer-icon" />
          Lun-Ven: 8h - 18h
        </p>
      </div>
      <div class="footer-social">
        <h4>Suivez-nous</h4>
        <a href="#"><img src="../images/facebook-svgrepo-com (1).svg" alt="Lien" class="social-icon" /></a>
        <a href="#"><img src="../images/instagram-167-svgrepo-com.svg" alt="Lien " class="social-icon" /></a>
        <a href="#"><img src="../images/linkedin-svgrepo-com (1).svg" alt="Lien " class="social-icon" /></a>
      </div>
      <p class="footer-copy">
