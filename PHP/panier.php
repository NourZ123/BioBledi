    ...
    <div class="container">
      <div class="leftC">
            ...
            <div class="row2">
              <div class="produits">
                ...
                <div class="info">
                  ...
                  <p class="price">
                    <?= number_format($item['prix_u'], 2) ?> DT/unité
                  </p>
                </div>
              </div>
              <div class="quantité">
                ...
                <?php else: ?>
                  <button disabled style="background: #ccc; cursor: not-allowed; opacity: 0.6;"
                    title="Stock maximum atteint">+</button>
                <?php endif; ?>
              </div>
              <div class="Total">
                <div class="price">
                  <?= number_format($item['sous_total'], 2) ?> DT
                </div>
        ...
        <div class="row4">
          <div>Total</div>
          <div class="sum">
            <?= number_format($total_articles, 2) ?> DT
          </div>
        </div>
      </div>
      <div class="rightC" style="height: 550px !important; width: 1000px !important">
        ...
        <div class="middle">
          ...
          if (isset($_SESSION['promo'])) {
            $p = $_SESSION['promo'];
            if ($p == "10")
              $remise = $total_articles * 0.10;
            if ($p == "15")
              $remise = $total_articles * 0.15;
            if ($p == "5")
              $remise = $total_articles * 0.05;
            if ($p == "FREE")
              $frais_livraison = 0;
        ...
        <div class="bottom">
          <a href="../PHP/finaliser ma commande.php" onclick="return verifierPanierVide(event)">
            <button class="valider">Valider ma commande</button>
          </a>
          <a href="../PHP/fruits et légumes.php">
