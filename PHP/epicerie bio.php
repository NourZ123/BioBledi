    ...
    <div class="head">
        ...
        <div class="head-right">
            <div class="head-actions">
                <a href="../PHP/check_compte.php"><img src="../images/person-svgrepo-com.svg" alt="person" class="user-icon" /></a>
                <a href="../PHP/panier.php"><img src="../images/cart-2-svgrepo-com.svg" alt="cart" class="cart-icon" /></a>
            </div>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-contact">
                ...
                <p><img src="../images/mail-check-svgrepo-com.svg" alt="Mail" class="footer-icon" /> contact@biobladi.tn</p>
                <p><img src="../images/location-svgrepo-com.svg" alt="Loc" class="footer-icon" /> Tunis, Tunisie</p>
                <p><img src="../images/time-svgrepo-com.svg" alt="Time" class="footer-icon" /> Lun-Ven: 8h - 18h</p>
            </div>
            <div class="footer-social">
                ...
                <a href="#"><img src="../images/linkedin-svgrepo-com (1).svg" alt="IN" class="social-icon" /></a>
            </div>
