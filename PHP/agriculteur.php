  ...
  <body>
    ...
    <div class="page-compte">
      <div class="menu-lateral">
        <div class="titre-section"><img src="../images/person-svgrepo-com.svg" class="icone-titre" /> Compte Agriculteur</div>
        <div class="liste-options">
          ...
          <div id="btn-dashboard" class="option-menu" style="padding: 10px"><img src="../images/screen-alt-2-svgrepo-com (1).svg" class="icone-menu" /> Statistiques</div>
          <div id="btn-Commande" class="option-menu" style="padding: 10px"><img src="../images/cart-large-2-svgrepo-com.svg" class="icone-menu" /> Mes produits</div>
