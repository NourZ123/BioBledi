...
<body>
  ...
  <div class="form-section">
    ...
    <form action="modifierproduit.php?id=<?= $produit['ID'] ?>" method="post" class="product-form"
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          <label>Remise (%)</label>
          <span class="current-val">Actuelle :
            <?= $produit['offre'] ?? 0 ?> %
          </span>
      ...
      <div class="form-group">
        ...
        <div style="margin-bottom: 10px;">
          <img src="../<?= $produit['image'] ?>" alt="actuelle"
            style="width: 80px; border-radius: 8px; border: 1px solid #ddd;">
        </div>
      ...
      <div style="margin-top: 25px; display: flex; align-items: center; gap: 20px;">
        ...
        <a href="../PHP/agriculteur.php"
          style="flex: 1; text-decoration: none; background-color: #f8faf8; text-align:center ; color:#14532d"
          class="submit-btn">Annuler</a>
